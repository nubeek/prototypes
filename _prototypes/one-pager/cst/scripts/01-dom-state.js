...
const isOnePagerPresentation = new URLSearchParams(window.location.search).get("presentation") === "one-pager";
...
const RADIUS_FILTER_DEFAULTS = { min: 0, max: 500, step: 1, value: 250 };
