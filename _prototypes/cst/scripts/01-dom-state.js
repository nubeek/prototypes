...
const saveLeadListSelect = document.getElementById("saveLeadListSelect");
const saveLeadListField = document.getElementById("saveLeadListField");
...
const cstSplashNewSearch = document.getElementById("cstSplashNewSearch");
...
const MAP_LOGO_MIN_ZOOM = 9;
const MAP_LOGO_DISPLAY_SIZE = 32;
const MAP_LOGO_TEXTURE_PIXEL_RATIO = 2;
const MAP_LOGO_HOVER_SCALE = 1.16;
